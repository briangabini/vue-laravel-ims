            ...
            <div class="relative min-h-[100vh] flex-1 rounded-xl border border-sidebar-border/70 md:min-h-min dark:border-border">
                <div class="p-4">
                    ...
                    <div class="mb-4">
                        ...
                        <p class="text-gray-600 dark:text-gray-300"><strong>Role:</strong> {{ user.role.name }}</p>
                    </div>
                    <Link :href="route('admin.users.edit', user.id)" class="bg-indigo-500 hover:bg-indigo-600 text-white px-4 py-2 rounded-md">Edit User</Link>
                </div>
            </div>
        </div>
    </AppLayout>
